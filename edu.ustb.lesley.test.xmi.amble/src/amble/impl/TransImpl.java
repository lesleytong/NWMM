 ...
 * </p>
 * <ul>
 *   <li>{@link amble.impl.TransImpl#getWaitFor <em>Wait For</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransImpl extends TransitionImpl implements Trans {
	/**
	...
	protected EClass eStaticClass() {
		return AmblePackage.Literals.TRANS;
	}
		...
		if (waitFor != null && waitFor.eIsProxy()) {
			...
			if (waitFor != oldWaitFor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmblePackage.TRANS__WAIT_FOR, oldWaitFor, waitFor));
			}
		}
		return waitFor;
	}
	...
	public void setWaitFor(Message newWaitFor) {
		...
		waitFor = newWaitFor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmblePackage.TRANS__WAIT_FOR, oldWaitFor, waitFor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AmblePackage.TRANS__WAIT_FOR:
