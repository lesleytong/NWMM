...
public class TestMake_7 {
	...
	public static void main(String[] args) {
		...
		URI baseURI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make.xmi");
		URI backupURI = URI.createFileURI(
				"E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make_backup.xmi");
		URI m0URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make_m0.xmi");
		URI m1URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make_m1.xmi");
		URI m2URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make_m2.xmi");

		Resource baseResource = resourceSet.getResource(baseURI, true);

		URI branch1URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make1.xmi");
		URI branch2URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make2.xmi");
		URI branch3URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make3.xmi");
		URI branch4URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make4.xmi");
		URI branch5URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make5.xmi");
		URI branch6URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make6.xmi");
		URI branch7URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.make\\src\\test07\\make7.xmi");
