...
public class TestFsm_3 {
	...
	public static void main(String[] args) {
		...
		URI baseURI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.fsm\\src\\test03\\fsm.xmi");
		URI backupURI = URI.createFileURI(
				"E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.fsm\\src\\test03\\fsm_backup.xmi");
		URI m0URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.fsm\\src\\test03\\fsm_m0.xmi");
		URI m1URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.fsm\\src\\test03\\fsm_m1.xmi");
		URI m2URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.fsm\\src\\test03\\fsm_m2.xmi");

		Resource baseResource = resourceSet.getResource(baseURI, true);

		URI branch1URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.fsm\\src\\test03\\fsm1.xmi");
		URI branch2URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.fsm\\src\\test03\\fsm2.xmi");
		URI branch3URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.fsm\\src\\test03\\fsm3.xmi");
