...
public class FsmAdapterFactory extends AdapterFactoryImpl {
	...
	protected FsmSwitch<Adapter> modelSwitch =
		new FsmSwitch<Adapter>() {
			@Override
			public Adapter caseMgaObject(MgaObject object) {
				return createMgaObjectAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseAssociationStateState(AssociationStateState object) {
				return createAssociationStateStateAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsm.MgaObject <em>Mga Object</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMgaObjectAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsm.RootFolder <em>Root Folder</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsm.AssociationStateState <em>Association State State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAssociationStateStateAdapter() {
		return null;
	}
