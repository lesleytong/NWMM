 ...
 * </p>
 * <ul>
 *   <li>{@link trace.impl.TraceImpl#getLevels <em>Levels</em>}</li>
...
public class TraceImpl extends MinimalEObjectImpl.Container implements Trace {
	...
	public EList<Level> getLevels() {
		if (levels == null) {
			levels = new EObjectContainmentWithInverseEList<Level>(Level.class, this, TracePackage.TRACE__LEVELS, TracePackage.LEVEL__TRACE);
		}
		return levels;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TracePackage.TRACE__LEVELS:
