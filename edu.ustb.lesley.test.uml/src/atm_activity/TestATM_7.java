...
public class TestATM_7 {
	...
	public static void main(String[] args) {
		...
		URI baseURI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity.uml");
		URI backupURI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity_backup.uml");
		URI m0URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity_m0.uml");
		URI m1URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity_m1.uml");
		URI m2URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity_m2.uml");

		Resource baseResource = resourceSet.getResource(baseURI, true);

		URI branch1URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity1.uml");
		URI branch2URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity2.uml");
		URI branch3URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity3.uml");
		URI branch4URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity4.uml");
		URI branch5URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity5.uml");
		URI branch6URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity6.uml");
		URI branch7URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\atm_activity\\atm_activity7.uml");
