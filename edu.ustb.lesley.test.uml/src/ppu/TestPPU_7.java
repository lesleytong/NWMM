...
public class TestPPU_7 {
	...
	public static void main(String[] args) {
		...
		URI baseURI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu.uml");
		Resource baseResource = resourceSet.getResource(baseURI, true);
		
		URI backupURI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu_backup.uml");
		URI m0URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu_m0.uml");
		URI m1URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu_m1.uml");
		URI m2URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu_m2.uml");

		URI branch1URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu1.uml");
		URI branch2URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu2.uml");
		URI branch3URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu3.uml");
		URI branch4URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu4.uml");
		URI branch5URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu5.uml");
		URI branch6URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu6.uml");
		URI branch7URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\ppu\\ppu7.uml");
