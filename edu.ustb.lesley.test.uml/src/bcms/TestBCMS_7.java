...
public class TestBCMS_7 {
	...
	public static void main(String[] args) {
		...
		URI baseURI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms.uml");
		Resource baseResource = resourceSet.getResource(baseURI, true);
		
		URI backupURI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms_backup.uml");
		URI m0URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms_m0.uml");
		URI m1URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms_m1.uml");
		URI m2URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms_m2.uml");

		URI branch1URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms1.uml");
		URI branch2URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms2.uml");
		URI branch3URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms3.uml");
		URI branch4URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms4.uml");
		URI branch5URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms5.uml");
		URI branch6URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms6.uml");
		URI branch7URI = URI.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.uml\\src\\bcms\\bcms7.uml");
