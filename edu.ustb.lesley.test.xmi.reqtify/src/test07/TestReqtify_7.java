...
public class TestReqtify_7 {
	...
	public static void main(String[] args) {
		...
		EPackage ep = ReqtifyPackage.eINSTANCE;

		URI baseURI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify.xmi");
		URI backupURI = URI.createFileURI(
				"E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify_backup.xmi");
		URI m0URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify_m0.xmi");
		URI m1URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify_m1.xmi");
		URI m2URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify_m2.xmi");

		Resource baseResource = resourceSet.getResource(baseURI, true);

		URI branch1URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify1.xmi");
		URI branch2URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify2.xmi");
		URI branch3URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify3.xmi");
		URI branch4URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify4.xmi");
		URI branch5URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify5.xmi");
		URI branch6URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify6.xmi");
		URI branch7URI = URI
				.createFileURI("E:\\eclipse-dsl-workspace\\edu.ustb.lesley.test.xmi.reqtify\\src\\test07\\reqtify7.xmi");
