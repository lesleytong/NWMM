 ...
 * </p>
 * <ul>
 *   <li>{@link reqtify.impl.ProjectImpl#getDocuments <em>Documents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProjectImpl extends MinimalEObjectImpl.Container implements Project {
	...
	protected EClass eStaticClass() {
		return ReqtifyPackage.Literals.PROJECT;
	}
	...
	public EList<Document> getDocuments() {
		if (documents == null) {
			documents = new EObjectContainmentWithInverseEList<Document>(Document.class, this, ReqtifyPackage.PROJECT__DOCUMENTS, ReqtifyPackage.DOCUMENT__PROJECT);
		}
		return documents;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReqtifyPackage.PROJECT__DOCUMENTS:
