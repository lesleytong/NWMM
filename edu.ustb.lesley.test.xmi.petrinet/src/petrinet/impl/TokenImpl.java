 ...
 * </p>
 * <ul>
 *   <li>{@link petrinet.impl.TokenImpl#getName <em>Name</em>}</li>
...
public class TokenImpl extends MinimalEObjectImpl.Container implements Token {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.TOKEN__NAME, oldName, name));
	}
	...
	public void setPlace(Place newPlace) {
		if (newPlace != eInternalContainer() || (eContainerFeatureID() != PetrinetPackage.TOKEN__PLACE && newPlace != null)) {
			...
			if (newPlace != null)
				msgs = ((InternalEObject)newPlace).eInverseAdd(this, PetrinetPackage.PLACE__TOKEN, Place.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case PetrinetPackage.TOKEN__PLACE:
				return eInternalContainer().eInverseRemove(this, PetrinetPackage.PLACE__TOKEN, Place.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetPackage.TOKEN__NAME:
				return getName();
			case PetrinetPackage.TOKEN__PLACE:
				return getPlace();
		}
