...
public class NetImpl extends MinimalEObjectImpl.Container implements Net {
	...
	public EList<Place> getPlace() {
		if (place == null) {
			place = new EObjectContainmentWithInverseEList<Place>(Place.class, this, PetrinetPackage.NET__PLACE, PetrinetPackage.PLACE__NET);
		}
		return place;
	}
	...
	public EList<Transition> getTransition() {
		if (transition == null) {
			transition = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this, PetrinetPackage.NET__TRANSITION, PetrinetPackage.TRANSITION__NET);
		}
		return transition;
	}
